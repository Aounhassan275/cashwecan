...
class EarningController extends Controller
{
    ...
    public function overall_earning(Request $request)
    {
        ...
        $labelsArray   = ["Direct Income", "Direct Team Income", "Upline Income", "Downline Income", "Upline Placement Income", "Downline Placement Income","Trade Income","Ranking Income"];
        $packagesData   = [
