...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">View Your Associated Income History</h5>
    ...
    <table class="table  datatable-basic datatable-row-basic">
        ...
        <tbody>
            @foreach (Auth::user()->associatedIncome as $key => $income)
                <tr>
                    <td>{{$key+1}}</td>
                ...
                <tr>
                    ...
                    <td>$ {{Auth::user()->associatedIncome->sum('price')}}</td>
                </tr>
        </tbody>
    </table>
</div>
<div class="row" >
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('user.earning.associated_income') }}" method="get">
                    <div class="row">
