...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">View Your Downline Placement Income History</h5>
    ...
    <table class="table  datatable-basic datatable-row-basic">
        ...
        <tbody>
            @foreach (Auth::user()->downlinePlacementIncome as $key => $income)
                <tr>
                    <td>{{$key+1}}</td>
                ...
                <tr>
                    ...
                    <td>$ {{Auth::user()->downlinePlacementIncome->sum('price')}}</td>
                </tr>
        </tbody>
    </table>
</div>
