...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">View Your Ranking Income History</h5>
    ...
    <table class="table  datatable-basic datatable-row-basic">
        ...
        <tbody>
            @foreach (Auth::user()->rankingIncome as $key => $income)
                <tr>
                    <td>{{$key+1}}</td>
                ...
                <tr>
                    ...
                    <td>$ {{Auth::user()->rankingIncome->sum('price')}}</td>
                </tr>
        </tbody>
    </table>
</div>
<div class="row" >
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('user.earning.ranking_income') }}" method="get">
                    <div class="row">
